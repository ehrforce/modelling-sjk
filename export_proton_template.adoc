...
|at0002| 1..1| DV_CODED_TEXT | Problem/diagnosenavn
a|
* Neoplastic disease (disorder) (SNOMED-CT: 55342001)


Koding av navnet på problemet eller diagnosen med en terminologi er foretrukket hvis mulig.
|at0079| 0..1| DV_CODED_TEXT | Funn i utredning
a|
* Primærtumor (med eller uten metastase(r)) (SNOMED-CT: 372087000)
* Lokalt residiv/progresjon (med eller uten metastase(r)) (SNOMED-CT: 1259237005)
* Kun metastase(r) (SNOMED-CT: 128462008)
* Annet (SNOMED-CT: 10003008)


For eksempel "akutt motorisk aksonal nevropati" som en variant av Guillain-Barre Syndrom. Koding av navnet på varianten med en terminologi er foretrukket hvis mulig.
|at0009| 0..1| DV_TEXT | Merknad
a|
...
5+a|*Anatomisk lokalisering* + 
CLUSTER: _openEHR-EHR-CLUSTER.anatomical_location.v1_
|at0001| 1..1| DV_CODED_TEXT | Anatomisk lokasjon
a|
* test (no.onk.anatomi_spesifikk.sarkom: 1)


Anatomisk lokalisering settes med kode som utviklet i kunnskapsbasen for Sarkomkreft. Se Excel ark med koblinger mellom morfologi, koder og anatomi. 
|at0065| 0..*| DV_CODED_TEXT | Spesifikt sted
a|
* test (no.onk.anatomi.sarkom: 1)


Spesifikt sted for anatomi er definert i eget Excel ark med kunnskapsbase for Sarkom. Filter for steder defineres av script basert på kunnskapsbasen. 
|at0002| 0..1| DV_CODED_TEXT | Kroppsside
a|
* Høyre (SNOMED-CT: 24028007)
* Venstre (SNOMED-CT: 7771000)
...
Hvis den identifiserte kroppssiden ikke har noen lateralitet, bør dette datalementet stå tomt. Hvis dataelementet "Navn på kroppsted" bruker prekoordinerte termer som inkluderer lateralitet, er dette dataelementet overflødig.
|at0023| 0..1| DV_TEXT | Merknad anatomisk lokalisering
a|
...
a|
* test (sjk_sarkom_icd10: 1)


BNA, 18.mars 2025: Her skal det vel stå ICD10 som kodeliste. Det er dette som settes/foreslås som følge av kunnskapsbasen fra Excel arket. 
|at0003| 0..1| DV_TEXT | Merknad ICD-10
a|
|at0073| 0..1| DV_CODED_TEXT | Diagnostisk sikkerhet
a|
* at0074 -> Mistenkt 
